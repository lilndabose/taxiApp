...
function LandingScreen() {
  return (
    <View style={tw`p-10`}>
      ...
      <TouchableOpacity style={tw`mt-2 bg-blue-400 p-4 rounded-md`}>
        <Text style={tw`self-center text-white`}>Sign Up</Text>
      </TouchableOpacity>
      <TouchableOpacity style={tw`mt-4 bg-white p-4 rounded-md border border-gray-300`}>
        <Text style={tw`self-center text-black`}>Log In</Text>
      </TouchableOpacity>
      <Text style={tw`self-center my-2 text-gray-400`}>or</Text>
      <TouchableOpacity style={tw`mt-2 bg-white p-4 rounded-md border border-gray-300`}>
